...
<div class="video-kuangs-newInfors video-kuangs-new" style="display:none;" >
    ...
    <!--comm-cons End--> 
      ...
      <div class="voideo-add3">
        <div class="video-add-cons">
          ...
          <div class="load-video">
           ...
           <div style="overflow: hidden;<c:if test='${video!=null && video.checkState==0 }'>display:none;</c:if>">
             ...
             <!--封面图-->
             <div class="fmt-images" style="display:none;">
               <em>视频封面图（封面图尺寸为1004*568；建议上传不超过3M，分辨率不小于1004*568，JPG、PNG格式的图片）</em>
             ...
             <div class="jcfw-images" style="display:none;">
              ...
              <input type="button" name = "cut-img" id = "cut_big_img_div" onclick="v.upload.img_cut();$('#img-tip').hide();" value="裁剪" class="btns-yl2" style="float:left"/>
             </div>
             <!-- 新图片裁剪 begin -->
             <div>
				 ...
				 <img id="cut_img" style="position: relative; top: -193px; left: 47px;" src="source.jpg" width="231" height="167">
				</div>
             	
             	<table cellspacing="0" cellpadding="0">
				  <tbody><tr>
				    <td><img style="margin-top: 5px; cursor:pointer;" src="/source/images/imagecut/_h.gif" alt="图片缩小" onmouseover="this.src='/source/images/imagecut/_c.gif'" onmouseout="this.src='/source/images/imagecut/_h.gif'" onclick="imageresize(false)"></td>
				...
				<img id="img_grip" style="position: absolute; z-index: 100; left: 99px; top: 312px; cursor: pointer;" src="images/grip.gif">
       ...
       <div class="video-add-cons" style="margin-top:300px;" >
