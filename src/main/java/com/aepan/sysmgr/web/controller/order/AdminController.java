 ...
 */
@Controller
public class AdminController extends DataTableController{
	private static final Logger logger = LoggerFactory.getLogger(VideoController.class);
	@Autowired
	OrderService orderService;
	@RequestMapping("/admin/orderpage")
	...
	public String searchOrder(HttpServletRequest request,HttpServletResponse res,ModelMap model){
		...
		return "/order/admin/listsub";
	}
	@RequestMapping("/admin/addlogistics")
